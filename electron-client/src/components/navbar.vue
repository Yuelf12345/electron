<template>
        <div class="navbar">
            <div class="navitem " :class="{ active: isActive === 0 }" @click="select(0)">
                <div class="indicator"></div>
                <div class="hoverindicator"></div>
                <div class="icon">
                    <svg t="1701352100009" class="icon" viewBox="0 0 1024 1024" version="1.1"
            ...
            <div class="navitem" :class="{ active: isActive === 1 }" @click="select(1)">
                <div class="indicator"></div>
                <div class="hoverindicator"></div>
                <div class="icon">
            ...
            <div class="navitem" :class="{ active: isActive === 2 }" @click="select(2)">
                <div class="indicator"></div>
                <div class="hoverindicator"></div>
                <div class="icon">
                    <svg xmlns="http://www.w3.org/2000/svg" class="ionicon s-ion-icon" viewBox="0 0 512 512">
